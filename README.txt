...
![Forward Backward icon](https://github.com/jmishra01/Custom-button-in-Matplotlib-toolbar/example/forward_backward_icon.png?raw=true)
...
![Custom Python icon](https://github.com/jmishra01/Custom-button-in-Matplotlib-toolbar/example/custom_python_icon.png?raw=true)
